...
public class ModelResultados extends ModelCore {
    ...
    public DefaultTableModel read() {
        ...
        String SQL = "SELECT * FROM mostrarListaResultados ";
    ...
    public DefaultTableModel search(String buscar) {
        ...
        DefaultTableModel tabla = new DefaultTableModel(null, titulos);
        String SQL = "SELECT * FROM mostrarListaResultados WHERE cedula LIKE '%"+buscar+"%' OR nombre LIKE '%"+buscar+"%' OR idcita LIKE '%"+buscar+"%'";
